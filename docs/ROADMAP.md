...
**👉 NEXT — P0-6** · Design Tokens + Typography + Tailwind Wiring (DS-01/02/03). OKLCH dark+light token system, Inter+Geist Mono typography, Tailwind v4 `@theme inline` — the design-system foundation before any component.
