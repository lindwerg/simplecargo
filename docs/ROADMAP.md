...
**👉 NEXT — P0-8** · Funnel Nav Shell + Login + Dashboard Shell (DS-05; ADR-D12). The grid-breaking funnel nav (Запросы → Направления → Отчётность) + designed login + server-gated dashboard placeholder, built on the P0-7 primitives.
