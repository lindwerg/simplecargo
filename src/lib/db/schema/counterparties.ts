...
export const counterparties = pgTable(
  "counterparties",
  {
    ...
    roles: text("roles").array().notNull().default([]), // {client,owner,expeditor,shipper,consignee,carrier}
    inn: varchar("inn", { length: 12 }),
    notes: text("notes"), // free-text notes about the company (Партнёры tab)
